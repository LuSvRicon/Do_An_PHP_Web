                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <div class="counter-block">
                                    <div class="counter-icon">
                                        <img src="{{('public/frontend/images/mobile_icon.png')}}" alt="">
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <div class="counter-block">
                                    <div class="counter-icon">
                                        <img src="{{('public/frontend/images/user_icon.png')}}" alt="">
                                    </div>
                                    <div class="counter-content">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <div class="counter-block">
                                    <div class="counter-icon">
                                        <img src="{{('public/frontend/images/location_icon.png')}}" alt="">
                                    </div>
                                    <div class="counter-content">
